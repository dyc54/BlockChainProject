...
const SellMedicine = () => {
    ...
    function sell(e) {
        ...
        fetch("http://localhost:8080/hospital/sellMedToPatient", {
            method: "POST",
            headers: {
            ...
            .then((responseData) => {
                if (responseData.success) {
                    alert("Sell successful and your order id is " + responseData.data);
                } else {
                    alert("Sell failed");
                }
            })
    ...
    return (
        <div className="mycontainer">
            <form className="login-form">
                ...
                <h1 className="h3 mb-3 fw-normal">Sell medicine</h1>
                <div className="mb-3">
                    <label className="form-label">Patient Id</label>
                    <input type="text" className="form-control" placeholder="Patient Id" onChange={(e) => setPatientId(e.target.value)} />
                </div>
                <div className="mb-3">
                ...
                <br />
                <button className="btn btn-success" onClick={sell}>Sell</button>
                <br />
            </form>
        </div>
    );
